				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav class="cl-effect-1" id="cl-effect-1">
						<ul class="nav navbar-nav">
							...
							<li><a href="#about" class="scroll hvr-bounce-to-bottom">Add a movie for Review</a></li>
			  ...
			  <div class="education-agile-grids">
				  <div class="education-agile-w3l" style="padding-left:100px;padding-top:80px;">
					 ...
					 <div class="education-agile-w3l-info">
					       <form method="POST" action="admin_login_graph.php" style="padding-left:40px; padding-top:20px;">
						   <select name="A">
						   <?php
						   include('db.php');
